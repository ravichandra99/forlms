...
class RegistrationForm(UserCreationForm):
    ...
    email = forms.EmailField(label=_("E-mail"),widget=forms.EmailInput(attrs={'placeholder': 'Email'}))
    ...
    class Meta:
        model = User
        fields = (UsernameField(),"first_name","last_name","email","mobile","college","branch")
        widgets = {
